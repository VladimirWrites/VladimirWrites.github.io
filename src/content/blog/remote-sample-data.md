...
What I've learned from my previous [article](/layout-preview/) is that the best way to gain new knowledge about a certain topic is to write about it. When I first wrote the article, I had no idea that you can create custom sampledata for your Android project. (If you don't have a clue what sampledata is, please read [tools:title="LayoutPreview"](/layout-preview/)) And then someone sent me [this](https://blog.stylingandroid.com/tool-time-part-2/).
...
<script src="https://gist.github.com/VladimirWrites/536060a2edddb6d6436f80bce82b7f8e.js"></script>

<script src="https://gist.github.com/VladimirWrites/b7bb9fdedebf535f4d9ee78ca2ca39b8.js"></script>
